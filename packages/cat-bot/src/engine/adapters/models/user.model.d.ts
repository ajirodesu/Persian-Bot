 ...
 */
export declare const PROTO_UNIFIED_USER_INFO: Readonly<UnifiedUserInfo>;
/**
 ...
 */
export declare function createUnifiedUserInfo(data: Partial<UnifiedUserInfo>): UnifiedUserInfo;
