 ...
 * the full Cat-Bot engine (handleMessage, handleButtonAction, all handlers).
 *
...
import {
  ...
  type ChatMessage,
  type ChatAttachment,
} from '@/engine/adapters/platform/webchat/api.js';
  ...
  io.on('connection', (socket) => {
    ...
    socket.on(
      ...
      (data: {
        ...
        const webChatApi = new WebChatApi(socket, activeSessionId, getSession);
    ...
    socket.on(
      ...
      (data: {
        ...
        const webChatApi = new WebChatApi(socket, sid, getSession);
