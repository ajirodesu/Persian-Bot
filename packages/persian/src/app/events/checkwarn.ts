/**
 * checkwarn.ts — Persian event handler
 ...
 *   Persian has no documented equivalent. If removeUser() fails,
...
export const onEvent = async ({
  ...
  for (const participant of added) {
    ...
    // and retry. That pattern has no documented equivalent in Persian.
    try {
