 ...
 *   Persian enforces meta.role globally, not per-subcommand.
 ...
 *   Persian has no documented equivalent. If thread.removeUser() fails, the
  ...
  switch (args[0]) {
    ...
    default: {
      ...
      if (times >= 3) {
        ...
        // Persian has no documented equivalent for that deferred pattern.
        try {
