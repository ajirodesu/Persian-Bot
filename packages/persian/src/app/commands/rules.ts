...
// ⚠️ GAP: Original accepted ANY emoji. Persian requires a static allowlist.
...
export const onCommand = async ({
  ...
  if (['remove', 'reset', '-r', '-rm'].includes(type)) {
    ...
    // ════════════════════════════════════════════════════════════════════════
    // BRANCH B — emoji reaction flow (platforms without native button support)
    // ════════════════════════════════════════════════════════════════════════
    const msgId = await chat.replyMessage({
      style: MessageStyle.MARKDOWN,
