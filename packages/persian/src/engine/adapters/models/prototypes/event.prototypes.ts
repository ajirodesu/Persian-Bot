/**
 * Persian — Event Prototype Objects
 *
...
export const PROTO_EVENT_MESSAGE = Object.freeze({
  ...
  /** String ms timestamp; may be number on some platforms. */
...
export const PROTO_EVENT_MESSAGE_REACTION = Object.freeze({
  ...
  /** Offline threading ID; empty string when not provided by platform. */
  offlineThreadingID: '',
});
...
/**
 * Shape for participants added to a group thread event.
 */
