 ...
 *
 * Every platform (Discord, Telegram) creates a concrete object
...
export class UnifiedApi {
   ...
   * Throws by default — override on platforms that expose an edit API (Telegram, Discord).
   */
  async editMessage(
    _messageID: string,
