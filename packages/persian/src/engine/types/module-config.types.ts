/**
 * Module Meta Type Definitions — CommandMeta & EventMeta
 *
 * Typed contracts for command and event module meta exports.
...
/**
 * Shape of each entry in a command's meta.options array.
 *
...
/**
 * Typed contract for command module meta exports.
 *
...
export interface EventMeta {
  ...
  /**
   * Platform allowlist — same semantics as CommandMeta.platform.
