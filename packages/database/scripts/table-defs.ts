...
export const collectionsMap: Record<string, string> = {
  ...
  botUserAiConfig: 'botUserAiConfigs',
...
export const tablesDef = [
  ...
  {
    jsonKey: 'botUserAiConfig',
    table: 'bot_user_ai_config',
    cols: {
      userId: 'user_id',
      openrouterEncryptedKey: 'openrouter_encrypted_key',
      openrouterKeyHint: 'openrouter_key_hint',
      openrouterModel: 'openrouter_model',
      groqEncryptedKey: 'groq_encrypted_key',
      groqKeyHint: 'groq_key_hint',
      groqModel: 'groq_model',
      nvidiaEncryptedKey: 'nvidia_encrypted_key',
      nvidiaKeyHint: 'nvidia_key_hint',
      nvidiaModel: 'nvidia_model',
      openaiEncryptedKey: 'openai_encrypted_key',
      openaiKeyHint: 'openai_key_hint',
      openaiModel: 'openai_model',
      geminiEncryptedKey: 'gemini_encrypted_key',
      geminiKeyHint: 'gemini_key_hint',
      geminiModel: 'gemini_model',
      zenEncryptedKey: 'zen_encrypted_key',
      zenKeyHint: 'zen_key_hint',
      zenModel: 'zen_model',
      orcarouterEncryptedKey: 'orcarouter_encrypted_key',
      orcarouterKeyHint: 'orcarouter_key_hint',
      orcarouterModel: 'orcarouter_model',
      fastrouterEncryptedKey: 'fastrouter_encrypted_key',
      fastrouterKeyHint: 'fastrouter_key_hint',
      fastrouterModel: 'fastrouter_model',
      provider: 'provider',
